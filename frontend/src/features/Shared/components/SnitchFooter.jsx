...
/* ─────────────────────────────────────────────────────────────────
   SnitchFooter
   Adapted from sshahaider/footer (21st.dev #5952)
   Restyled for Snitch brand:  #fbf9f6 bg, #C9A96E gold, no shadcn
───────────────────────────────────────────────────────────────────*/
...
const Newsletter = () => {
  ...
  return (
    <div className="flex flex-col gap-3 max-w-[320px]">
      ...
      {sent ? (
        <p className="text-[0.7rem] tracking-[0.1em] uppercase" style={{ color: "#C9A96E" }}>
          ✓ You&apos;re on the list
        </p>
      ) : (
    ...
    <div className="max-w-[1400px] mx-auto px-8 py-14 grid grid-cols-1 md:grid-cols-[1fr_auto] gap-12">
      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-2">
          <span
            className="text-[1.1rem] tracking-[0.4em] uppercase"
          ...
          <p
            ...
            style={{ color: "#6b6158", fontFamily: "'Inter', sans-serif" }}
          >
            Curated essentials for the considered wardrobe. Craft, finish, and
            enduring relevance.
          </p>
          <SocialRow />
        </div>
