...
- **Interactive Reviews**: Buyer rating and review submission system with aggregation.
...
| **Backend** | Node.js, Express 5, Mongoose 9, Passport.js, JWT, bcryptjs, Multer, ImageKit SDK, Razorpay SDK, Morgan |
...
│   └── src/
│       ├── app.js              # Express app, CORS, Passport, routes, SPA wildcard fallback
...
| `POST` | `/api/reviews` | Buyer | Submit a product review |
