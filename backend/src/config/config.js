...
if (!process.env.IMAGEKIT_PUBLIC_KEY) {
  throw new Error("IMAGEKIT_PUBLIC_KEY is not defined in environment variable");
}

if (!process.env.IMAGEKIT_URL_ENDPOINT) {
  throw new Error(
    "IMAGEKIT_URL_ENDPOINT is not defined in environment variable",
  );
}
...
export const config = {
  ...
  CLIENT_URL: process.env.CLIENT_URL || "https://luxurisen.onrender.com",
